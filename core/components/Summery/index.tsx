...
const index = () => {
  ...
  userData.map((e, i) => {
    ...
    myData.push({ target: engName, volume: volume });
  });
  const initial = 0;
      ...
      <div className='flex  w-1/2 h-[90%]'>
        <Container>
          ...
          <div className='flex flex-col justify-center items-center w-full h-1/4 border-white border-t-2'>
            <div className='flex flex-col w-[80%]   items-start bg-white/30 rounded-[10px] border backdrop-blur-md drop-shadow-xl z-10'>
